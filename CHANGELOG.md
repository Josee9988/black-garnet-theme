...
* Removed demos folder as it as useless.

### Added

* README.md file in the themes folder explaining what this folder contains.
...
* Multiple files to ignore in .vscode ignore so it will make the theme a bit smoother.

### Changed

* Location of the file "CODE_OF_CONDUCT.MD" from main folder to .github.

## [**1.0.2**] - 2019-08-08

### Changed

* Colour for CSS values.

## [**1.0.1**] - 2019-08-07

### Changed

* Badges links in the readme.md file.
* Changelog header.
* Changelog asterisk instead of a hyphen at the lists.
